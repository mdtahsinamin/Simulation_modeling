...
def main():
    ...
    cumulative_prob_interarrival = [0, 0.05, 0.4, 0.65, 0.80, 0.90, 0.97,
                                    1.0]  # Array of cumulative probabilities for interarrival times
    ...
    for num_servers in range(2, s + 1):
        ...
        for arrival_counter in range(1, run + 1):
            ...
            for i in range(n):
                if random_value > cumulative_prob_interarrival[i] and random_value <= cumulative_prob_interarrival[
                    i + 1]:
